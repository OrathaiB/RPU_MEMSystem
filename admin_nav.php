                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'formrequests.php' ? 'active' : ''; ?>"
                            ...
                            <i class="fas fa-file-alt me-1"></i>สร้างแบบฟอร์ม
                        </a>
                    </li>
                    <!-- <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'document_list.php' ? 'active' : ''; ?>"
                            href="document_list.php">
                            <i class="fas fa-list me-1"></i>ข้อมูลแบบฟอร์มทั้งหมด
                        </a>
                    </li> -->
                    
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'userlist.php' ? 'active' : ''; ?>"
                            href="userlist.php">
                            <i class="fas fa-users me-1"></i>ข้อมูลผู้ใช้งาน
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'list_courses.php' ? 'active' : ''; ?>"
                            href="courses.php">
