...
<head>
    ...
    <title>รายการเอกสารที่ไม่อนุมัติ</title>
...
<body>
    ...
    <div class="container-fluid mt-5">
        <h2 class="mb-4"><center>รายการเอกสารไม่อนุมัติ</center></h2>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='12' class='text-center'>ไม่พบข้อมูลเอกสารที่ไม่อนุมัติ</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
