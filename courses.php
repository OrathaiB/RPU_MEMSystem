...
<head>
    <meta charset="UTF-8">
    <title>จัดการหลักสูตรรายวิชา</title>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-2">
                        <a href="add_course.php" class="btn btn-warning" style="float: right;">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_course.php?code=<?php echo urlencode($row['course_code']); ?>"
